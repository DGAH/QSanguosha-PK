...
namespace QSanProtocol {
    ...
    enum CommandType
    {
		...
		S_COMMAND_SHOW_INFORMATION,
		// special mode
		S_COMMAND_CHECK_TASK,
		S_COMMAND_UPDATE_TASK,
		S_COMMAND_CHECK_PROGRESS,
		S_COMMAND_UPDATE_PROGRESS,
		S_COMMAND_CHOOSE_KOFGAME_TEAM,
		S_COMMAND_CONFIRM_KOFGAME_GENERALS,
		S_COMMAND_ARRANGE_KOFGAME_GENERALS,
		S_COMMAND_UPDATE_KOFGAME_ROOMSCENE
    };
